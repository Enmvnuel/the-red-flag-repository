...
export default function MujeresPage() {
  ...
  const reportesMujeres = mockReportes.filter((r) => r.genero === "mujer");

  const reportesFiltrados = reportesMujeres.filter((reporte) => {
  ...
  const ciudades = Array.from(new Set(reportesMujeres.map((r) => r.ciudad)));

  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 px-6 py-12">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl">Denuncias de Mujeres</h1>
          <p className="mt-4 text-lg text-gray-600">Reportes de mujeres infieles</p>
        </div>
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-300 py-3 pl-12 pr-4 text-gray-900 focus:border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500/20"
              />
            </div>
            ...
            <div className="relative sm:w-48">
              ...
              <select
                ...
                className="w-full appearance-none rounded-lg border border-gray-300 py-3 pl-12 pr-4 text-gray-900 focus:border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500/20"
              >
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {reportesFiltrados.map((reporte) => (
            <Link
              ...
              className="group rounded-2xl border border-gray-200 bg-white p-6 shadow-lg transition-all hover:border-pink-300 hover:shadow-2xl"
            >
